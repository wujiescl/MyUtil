...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,ChoosePayBankPopupWindow.OnItemClickListener{
    ...
    public void onItemClick(int which) {
        Toast.makeText(MainActivity.this,"选中了"+list_bigdata.get(which).getBankName(), Toast.LENGTH_LONG).show();
    ...
    public void onAddCardClick() {
        ...
        Contact.CHOOSE_MONET=false;
        Toast.makeText(MainActivity.this,"选中了添加银行卡", Toast.LENGTH_LONG).show();

    }

    @Override
    public void onMoneyClick() {
        Toast.makeText(MainActivity.this,"选中了余额支付", Toast.LENGTH_LONG).show();
        for (int i = 0; i <list_bigdata.size() ; i++) {
            list_bigdata.get(i).setChoose(false);
        }
