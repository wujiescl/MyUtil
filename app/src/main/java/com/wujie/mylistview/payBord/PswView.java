...
public class PswView extends View {
    ...
    public PswView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPsw_size = tArray.getDimensionPixelSize(R.styleable.PwdTextView_psw_size, 16);
        mPsw_color = tArray.getColor(R.styleable.PwdTextView_psw_color, Color.parseColor("#2b2b2b"));
